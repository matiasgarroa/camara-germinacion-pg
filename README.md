...
* **Semana 4:** Se realizarón las siguientes reformas y buenas practicas en el codigo:
  ...
  - Histéresis (Cuidado de Relés): En tu código original, si la humedad oscilaba rápidamente entre 39.9% y 40.1%, el relé se prendía y apagaba frenéticamente, acortando su vida útil. Se agregó la constante HISTERESIS. Ahora el humidificador enciende si cae a 38% y solo se apaga al tocar el 40%.
